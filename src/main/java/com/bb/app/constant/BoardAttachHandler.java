...
public class BoardAttachHandler {

    private final BoardAttachMapper boardAttachMapper;

    public List<BoardAttachEntity> parseFileInfo(
        ...
        if(!CollectionUtils.isEmpty(multipartFiles)) {
            ...
            for(MultipartFile multipartFile : multipartFiles) {
               ...
               // BoardAttachEntity boardAttachEntity = boardAttachMapper.toEntity(boardAttachDto);
